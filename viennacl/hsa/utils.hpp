...
namespace viennacl
{
  namespace hsa
  {
    ...
    struct DOUBLE_PRECISION_CHECKER
    {
      ...
      static void apply(viennacl::hsa::context const &)
      {
      }
    };
    ...
    struct DOUBLE_PRECISION_CHECKER<double>
    {
      ...
      static void apply(viennacl::hsa::context const & ctx)
      {
        if (!ctx.current_device().double_support())
          throw viennacl::hsa::double_precision_not_provided_error();
      }
    };
    /** \endcond */
    ...
    template<> struct type_to_string<short>
    {
    ...
    template<> struct type_to_string<long>
    {
    ...
    template<> struct type_to_string<unsigned char>
    {
    ...
    template<> struct type_to_string<unsigned short>
    {
    ...
    template<> struct type_to_string<unsigned int>
    {
    ...
    template<> struct type_to_string<unsigned long>
    {
    ...
    template<typename T>
    void append_double_precision_pragma(viennacl::hsa::context const & /*ctx*/, std::string & /*source*/)
    {
    }

    template<>
    inline void append_double_precision_pragma<double>(viennacl::hsa::context const & ctx, std::string & source)
    {
