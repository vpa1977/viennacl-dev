#ifndef VIENNACL_LINALG_HSA_KERNELS_COORDINATE_MATRIX_HPP
#define VIENNACL_LINALG_HSA_KERNELS_COORDINATE_MATRIX_HPP
...
/** @file viennacl/linalg/hsa/kernels/coordinate_matrix.hpp
...
namespace detail
{
                                                   ...
                                                   bool B_transposed, bool B_row_major, bool C_row_major)
  {
    ...
    source.append(viennacl::linalg::hsa::detail::sparse_dense_matmult_kernel_name(B_transposed, B_row_major, C_row_major));
    source.append("( \n");
    source.append("  __global const uint2 * coords,  \n");//(row_index, column_index)
    source.append("  __global const "); source.append(numeric_string); source.append(" * elements, \n");
    source.append("  __global const uint  * group_boundaries, \n");
...
struct coordinate_matrix
{
  ...
  {
    return viennacl::hsa::type_to_string<NumericT>::apply() + "_coordinate_matrix";
  }
