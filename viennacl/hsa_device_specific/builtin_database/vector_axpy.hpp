#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_VECTOR_AXPY_HPP_
#define VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_VECTOR_AXPY_HPP_
...
/** @file viennacl/hsa_device_specific/builtin_database/vector_axpy.hpp
*
...
vector_axpy_template::parameters_type const & vector_axpy_params(vcl::device const & device)
{
