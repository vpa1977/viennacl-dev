#ifndef VIENNACL_LINALG_HSA_ITERATIVE_OPERATIONS_HPP_
#define VIENNACL_LINALG_HSA_ITERATIVE_OPERATIONS_HPP_
...
{
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(result));
  viennacl::linalg::opencl::kernels::iterative<NumericT, viennacl::hsa::context>::init(ctx);

  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<NumericT>::program_name(), "cg_vector_update");
  ...
  viennacl::hsa::enqueue(k(result, alpha, p, r, Ap, beta, inner_prod_buffer, vec_size, viennacl::hsa::local_mem(k.local_work_size() * sizeof(NumericT))));
}
                       ...
                       vector_base<NumericT> & inner_prod_buffer)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<NumericT>::program_name(), use_nvidia_blocked ? "cg_csr_blocked_prod" : "cg_csr_prod");
  ...
  if (use_nvidia_blocked)
  {
    viennacl::hsa::enqueue(k(A.handle1().hsa_handle(), A.handle2().hsa_handle(), A.handle().hsa_handle(),
                             ...
                             viennacl::hsa::local_mem(k.local_work_size() * sizeof(NumericT)),
                             viennacl::hsa::local_mem(k.local_work_size() * sizeof(NumericT))
                            ));
  }
  else
  {
    viennacl::hsa::enqueue(k(A.handle1().hsa_handle(), A.handle2().hsa_handle(), A.handle3().hsa_handle(), A.handle().hsa_handle(), cl_uint(A.blocks1()),
                             ...
                             viennacl::hsa::local_mem(k.local_work_size() * sizeof(NumericT)),
                             viennacl::hsa::local_mem(k.local_work_size() * sizeof(NumericT)),
                             viennacl::hsa::local_mem(1024 * sizeof(NumericT))
                            ));
  }
                       ...
                       vector_base<NumericT> & inner_prod_buffer)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<NumericT>::program_name(), "cg_coo_prod");
                       ...
                       vector_base<NumericT> & inner_prod_buffer)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<NumericT>::program_name(), "cg_ell_prod");
  ...
  viennacl::hsa::enqueue(k(A.handle2().hsa_handle(),
                           ...
                           viennacl::traits::hsa_handle(p),
                           viennacl::traits::hsa_handle(Ap),
                           vec_size,
                           inner_prod_buffer,
                           buffer_size_per_vector,
                           viennacl::hsa::local_mem(k.local_work_size() * sizeof(NumericT)),
                       ...
                       vector_base<NumericT> & inner_prod_buffer)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<NumericT>::program_name(), "cg_sliced_ell_prod");
                       ...
                       vector_base<NumericT> & inner_prod_buffer)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<NumericT>::program_name(), "cg_hyb_prod");
...
{
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(s));
  viennacl::linalg::opencl::kernels::iterative<NumericT, viennacl::hsa::context>::init(ctx);

  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<NumericT>::program_name(), "bicgstab_update_s");
                                      ...
                                      vector_base<NumericT> & inner_prod_buffer, vcl_size_t buffer_chunk_size)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<NumericT>::program_name(), "bicgstab_vector_update");
  cl_uint    vec_size = cl_uint(viennacl::traits::size(result));
  ...
  viennacl::hsa::enqueue(k(result, alpha, p, omega, s,
                           residual, As,
                           beta, Ap,
                           r0star,
                           inner_prod_buffer,
                           vec_size, viennacl::hsa::local_mem(k.local_work_size() * sizeof(NumericT))
                           )
                         );
}
                             ...
                             vcl_size_t buffer_chunk_offset)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<NumericT>::program_name(), use_nvidia_blocked ? "bicgstab_csr_blocked_prod" : "bicgstab_csr_prod");
                             ...
                             vcl_size_t buffer_chunk_offset)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<NumericT>::program_name(), "bicgstab_coo_prod");
  unsigned int thread_num = 256; //k.local_work_size(0);
                             ...
                             vcl_size_t buffer_chunk_offset)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<NumericT>::program_name(), "bicgstab_ell_prod");
                             ...
                             vcl_size_t buffer_chunk_offset)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<NumericT>::program_name(), "bicgstab_sliced_ell_prod");
                             ...
                             vcl_size_t buffer_chunk_offset)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<NumericT>::program_name(), "bicgstab_hyb_prod");
...
void pipelined_gmres_normalize_vk(vector_base<T> & v_k,
                                  ...
                                  vcl_size_t buffer_chunk_offset)
{
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(v_k));
  viennacl::linalg::opencl::kernels::iterative<T, viennacl::hsa::context>::init(ctx);

  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<T>::program_name(), "gmres_normalize_vk");
  ...
  cl_uint chunk_size   = cl_uint(buffer_chunk_size);
  cl_uint chunk_offset = cl_uint(buffer_chunk_offset);
  viennacl::hsa::enqueue(k(v_k, vk_offset,
                           residual,
                           R_buffer, R_offset,
                           inner_prod_buffer, chunk_size,
                           r_dot_vk_buffer, chunk_offset,
                           size_vk,
                           viennacl::hsa::local_mem(k.local_work_size() * sizeof(T))
                           ));
}
...
void pipelined_gmres_gram_schmidt_stage1(vector_base<T> const & device_krylov_basis,
                                         ...
                                         vcl_size_t buffer_chunk_size)
{
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(device_krylov_basis));
  viennacl::linalg::opencl::kernels::iterative<T, viennacl::hsa::context>::init(ctx);

  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<T>::program_name(), "gmres_gram_schmidt_1");
  ...
  cl_uint chunk_size = cl_uint(buffer_chunk_size);
  viennacl::hsa::enqueue(k(device_krylov_basis, size_vk, internal_size_vk, ocl_k,
                                         ...
                                         vcl_size_t buffer_chunk_size)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<T>::program_name(), "gmres_gram_schmidt_2");
  ...
  viennacl::hsa::enqueue(k(device_krylov_basis, size_vk, internal_size_vk, ocl_k,
                           ...
                           inner_prod_buffer,
                           viennacl::hsa::local_mem(7 * k.local_work_size() * sizeof(T))
                           ));
}
                                   ...
                                   vcl_size_t param_k)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<T>::program_name(), "gmres_update_result");
                          ...
                          vector_base<T> & inner_prod_buffer)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<T>::program_name(), use_nvidia_blocked ? "gmres_csr_blocked_prod" : "gmres_csr_prod");
  ...
  else
  {
    viennacl::hsa::enqueue(k(A.handle1().hsa_handle(), A.handle2().hsa_handle(), A.handle3().hsa_handle(), A.handle().hsa_handle(), cl_uint(A.blocks1()),
                             ...
                             viennacl::hsa::local_mem(k.local_work_size() * sizeof(T)),
                             viennacl::hsa::local_mem(k.local_work_size() * sizeof(T)),
                             viennacl::hsa::local_mem(1024 * sizeof(T))
                            ));
  }
}
                          ...
                          vector_base<T> & inner_prod_buffer)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<T>::program_name(), "gmres_coo_prod");
  ...
  viennacl::hsa::enqueue(k(A.handle12().hsa_handle(), A.handle().hsa_handle(), A.handle3().hsa_handle(),
                           ...
                           vec_size,
                           viennacl::hsa::local_mem(sizeof(cl_uint)*thread_num),
                           viennacl::hsa::local_mem(sizeof(T)*thread_num),
                           inner_prod_buffer,
                           buffer_size_per_vector,
                           viennacl::hsa::local_mem(k.local_work_size() * sizeof(T)),
                           viennacl::hsa::local_mem(k.local_work_size() * sizeof(T))
                          ...
                          vector_base<T> & inner_prod_buffer)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<T>::program_name(), "gmres_ell_prod");
  ...
  viennacl::hsa::enqueue(k(A.handle2().hsa_handle(),
                           ...
                           cl_uint(A.maxnnz()),
                           cl_uint(A.internal_maxnnz()),
                           viennacl::traits::hsa_handle(p), start_p,
                           viennacl::traits::hsa_handle(Ap), start_Ap,
                           vec_size,
                           inner_prod_buffer,
                           buffer_size_per_vector,
                           viennacl::hsa::local_mem(k.local_work_size() * sizeof(T)),
                          ...
                          vector_base<T> & inner_prod_buffer)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<T>::program_name(), "gmres_sliced_ell_prod");
                          ...
                          vector_base<T> & inner_prod_buffer)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::iterative<T>::program_name(), "gmres_hyb_prod");
