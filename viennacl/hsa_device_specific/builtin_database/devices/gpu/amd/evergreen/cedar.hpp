#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_DEVICES_GPU_AMD_EVERGREEN_CEDAR_HPP_
#define VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_DEVICES_GPU_AMD_EVERGREEN_CEDAR_HPP_
...
{
  db.add_4B(ocl::amd_id, CL_DEVICE_TYPE_GPU, ocl::evergreen, "Cedar", reduction_template::parameters_type(1,128,256,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_4B(database_type<matrix_product_template::parameters_type> & db, char_to_type<'T'>, char_to_type<'T'>)
{
  db.add_4B(ocl::amd_id, CL_DEVICE_TYPE_GPU, ocl::evergreen, "Cedar", matrix_product_template::parameters_type(1,8,8,8,4,4,4,FETCH_FROM_LOCAL,FETCH_FROM_LOCAL,8,8));
}
...
{
  db.add_4B(ocl::amd_id, CL_DEVICE_TYPE_GPU, ocl::evergreen, "Cedar", row_wise_reduction_template::parameters_type(8,1,128,4096,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_4B(database_type<row_wise_reduction_template::parameters_type> & db, char_to_type<'N'>)
{
  db.add_4B(ocl::amd_id, CL_DEVICE_TYPE_GPU, ocl::evergreen, "Cedar", row_wise_reduction_template::parameters_type(8,32,4,128,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_4B(database_type<matrix_axpy_template::parameters_type> & db)
{
  db.add_4B(ocl::amd_id, CL_DEVICE_TYPE_GPU, ocl::evergreen, "Cedar", matrix_axpy_template::parameters_type(1,32,4,16,128,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_4B(database_type<vector_axpy_template::parameters_type> & db)
{
  db.add_4B(ocl::amd_id, CL_DEVICE_TYPE_GPU, ocl::evergreen, "Cedar", vector_axpy_template::parameters_type(1,128,1024,FETCH_FROM_GLOBAL_STRIDED));
}
