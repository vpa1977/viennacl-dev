#ifndef VIENNACL_HSA_ERROR_HPP_
#define VIENNACL_HSA_ERROR_HPP_
...
/** @file viennacl/hsa/error.hpp
    @brief Error handling for the OpenCL layer of ViennaCL
*/

//error levels:
//#define VIENNACL_DEBUG_ALL           //print all of the following
//#define VIENNACL_DEBUG_KERNEL        //debug any modifications on viennacl::hsa::kernel objects
...
#ifndef VIENNACL_HSA_ERR_CHECK
#define VIENNACL_HSA_ERR_CHECK(err) viennacl::hsa::error_checker<void>::checkError(err, __FILE__, __FUNCTION__, __LINE__);
#endif
