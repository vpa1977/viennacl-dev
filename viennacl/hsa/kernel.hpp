...
/** @file viennacl/hsa/kernel.hpp
    @brief Representation of an HSA kernel in ViennaCL.
 */
  ...
  namespace hsa
  {
    ...
    class kernel_arg_buffer
    {
      ...
      struct arg_ref
      {
        ...
        arg_ref() : local(false), size(0), ptr(0)
        {
    ...
    public:
      ...
      /** @brief Sets an HSA local memory object at the provided position */
