#ifndef VIENNACL_LINALG_HSA_KERNELS_SLICED_ELL_MATRIX_HPP
#define VIENNACL_LINALG_HSA_KERNELS_SLICED_ELL_MATRIX_HPP
...
struct sliced_ell_matrix<NumericT, unsigned int>
{
  ...
  {
    return viennacl::hsa::type_to_string<NumericT>::apply() + viennacl::hsa::type_to_string<unsigned int>::apply() + "_sliced_ell_matrix";
  }
