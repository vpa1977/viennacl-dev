#ifndef VIENNACL_LINALG_HSA_KERNELS_ELL_MATRIX_HPP
#define VIENNACL_LINALG_HSA_KERNELS_ELL_MATRIX_HPP
...
struct ell_matrix
{
  ...
  {
    return viennacl::hsa::type_to_string<NumericT>::apply() + "_ell_matrix";
  }
