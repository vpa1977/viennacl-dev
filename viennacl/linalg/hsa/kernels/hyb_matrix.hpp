#ifndef VIENNACL_LINALG_HSA_KERNELS_HYB_MATRIX_HPP
#define VIENNACL_LINALG_HSA_KERNELS_HYB_MATRIX_HPP
...
struct hyb_matrix
{
  ...
  {
    return viennacl::hsa::type_to_string<NumericT>::apply() + "_hyb_matrix";
  }
