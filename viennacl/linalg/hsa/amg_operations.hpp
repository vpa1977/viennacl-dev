#ifndef VIENNACL_LINALG_HSA_AMG_OPERATIONS_HPP
#define VIENNACL_LINALG_HSA_AMG_OPERATIONS_HPP
                           ...
                           viennacl::linalg::amg_tag & tag)
{
  ...
  viennacl::linalg::opencl::kernels::amg<NumericT, viennacl::hsa::context>::init(ctx);
  viennacl::hsa::kernel & influence_kernel = ctx.get_kernel(viennacl::linalg::opencl::kernels::amg<NumericT>::program_name(), "amg_influence_trivial");

  viennacl::hsa::enqueue(influence_kernel(A.handle1().hsa_handle(), A.handle2().hsa_handle(),
                                          cl_uint(A.size1()),
                                          cl_uint(A.nnz()),
                                          viennacl::traits::hsa_handle(amg_context.influence_jumper_),
                                          viennacl::traits::hsa_handle(amg_context.influence_ids_),
                                          viennacl::traits::hsa_handle(amg_context.influence_values_)
                                         )
                         );
}
                               ...
                               viennacl::linalg::amg_tag & tag)
{
  ...
  viennacl::hsa::kernel & init_workdata_kernel    = ctx.get_kernel(viennacl::linalg::opencl::kernels::amg<NumericT>::program_name(), "amg_pmis2_init_workdata");
  viennacl::hsa::kernel & max_neighborhood_kernel = ctx.get_kernel(viennacl::linalg::opencl::kernels::amg<NumericT>::program_name(), "amg_pmis2_max_neighborhood");
  viennacl::hsa::kernel & mark_mis_nodes_kernel   = ctx.get_kernel(viennacl::linalg::opencl::kernels::amg<NumericT>::program_name(), "amg_pmis2_mark_mis_nodes");
  viennacl::hsa::kernel & reset_state_kernel      = ctx.get_kernel(viennacl::linalg::opencl::kernels::amg<NumericT>::program_name(), "amg_pmis2_reset_state");
  ...
  while (num_undecided > 0)
  {
    ...
    //
    viennacl::hsa::enqueue(init_workdata_kernel(work_state,  work_random,  work_index,
    ...
    {
      // max operation
      viennacl::hsa::enqueue(max_neighborhood_kernel(work_state,  work_random,  work_index,
    ...
    //
    viennacl::hsa::enqueue(mark_mis_nodes_kernel(work_state, work_index,
                                                 amg_context.point_types_,
                                                 undecided_buffer,
                                                 cl_uint(A.size1())
                                                )
  ...
  viennacl::hsa::enqueue(reset_state_kernel(amg_context.point_types_, cl_uint(amg_context.point_types_.size()) ) );
}
                   ...
                   viennacl::linalg::amg_tag & tag)
{
  ...
  //
  viennacl::hsa::kernel & propagate_coarse_indices = ctx.get_kernel(viennacl::linalg::opencl::kernels::amg<NumericT>::program_name(), "amg_agg_propagate_coarse_indices");
  viennacl::hsa::enqueue(propagate_coarse_indices(amg_context.point_types_,
  ...
  //
  viennacl::hsa::kernel & merge_undecided = ctx.get_kernel(viennacl::linalg::opencl::kernels::amg<NumericT>::program_name(), "amg_agg_merge_undecided");
  viennacl::hsa::enqueue(merge_undecided(amg_context.point_types_,
                                         amg_context.coarse_id_,
                                         amg_context.influence_jumper_,
                                         amg_context.influence_ids_,
                                         cl_uint(A.size1())
  ...
  //
  viennacl::hsa::kernel & merge_undecided_2 = ctx.get_kernel(viennacl::linalg::opencl::kernels::amg<NumericT>::program_name(), "amg_agg_merge_undecided_2");
  viennacl::hsa::enqueue(merge_undecided_2(amg_context.point_types_, cl_uint(A.size1()) ) );
                     ...
                     viennacl::linalg::amg_tag & tag)
{
  ...
  // build matrix here
  viennacl::hsa::kernel & interpolate_ag = ctx.get_kernel(viennacl::linalg::opencl::kernels::amg<NumericT>::program_name(), "amg_interpol_ag");
  viennacl::hsa::enqueue(interpolate_ag(P.handle1().hsa_handle(),
                                        P.handle2().hsa_handle(),
                                        P.handle().hsa_handle(),
                                        amg_context.coarse_id_,
                                        cl_uint(A.size1())
                                        )
                     ...
                     viennacl::linalg::amg_tag & tag)
{
  ...
  viennacl::hsa::kernel & interpol_sa = ctx.get_kernel(viennacl::linalg::opencl::kernels::amg<NumericT>::program_name(), "amg_interpol_sa");
  viennacl::hsa::enqueue(interpol_sa(A.handle1().hsa_handle(),
                                     A.handle2().hsa_handle(),
                                     A.handle().hsa_handle(),
                                     cl_uint(A.size1()),
                                     cl_uint(A.nnz()),
                                     Jacobi.handle1().hsa_handle(),
                                     Jacobi.handle2().hsa_handle(),
                                     Jacobi.handle().hsa_handle(),
                   ...
                   NumericT weight)
{
  ...
  viennacl::linalg::opencl::kernels::compressed_matrix<NumericT, viennacl::hsa::context>::init(ctx);
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "jacobi");
  ...
  for (unsigned int i=0; i<iterations; ++i)
  {
    ...
    viennacl::hsa::enqueue(k(A.handle1().hsa_handle(), A.handle2().hsa_handle(), A.handle().hsa_handle(),
                            ...
                            viennacl::traits::hsa_handle(x_backup),
                            viennacl::traits::hsa_handle(x),
                            viennacl::traits::hsa_handle(rhs_smooth),
