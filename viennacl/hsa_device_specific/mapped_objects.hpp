#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_MAPPED_TYPE_HPP
#define VIENNACL_HSA_DEVICE_SPECIFIC_MAPPED_TYPE_HPP
...
/** @file viennacl/hsa_device_specific/mapped_objects.hpp
