#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_TEMPLATES_REDUCTION_TEMPLATE_HPP
#define VIENNACL_HSA_DEVICE_SPECIFIC_TEMPLATES_REDUCTION_TEMPLATE_HPP
...
/** @file viennacl/hsa_device_specific/templates/reduction_template.hpp
 *
...
#include "viennacl/hsa_device_specific/templates/utils.hpp"
...
private:
  ...
  int check_invalid_impl(vcl::device const & /*dev*/) const
  {
...
private:
  ...
  std::vector< vcl::handle<cl_mem> > tmpidx_;
#endif
};
