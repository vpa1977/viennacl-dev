#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_MATRIX_AXPY_HPP_
#define VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_MATRIX_AXPY_HPP_
...
/** @file viennacl/hsa_device_specific/builtin_database/matrix_axpy.hpp
*
...
matrix_axpy_template::parameters_type const & matrix_axpy_params(hsa::device const & device)
{
