#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_TEMPLATES_REDUCTION_UTILS_HPP
#define VIENNACL_HSA_DEVICE_SPECIFIC_TEMPLATES_REDUCTION_UTILS_HPP
...
/** @file viennacl/hsa_device_specific/templates/utils.hpp
 *
