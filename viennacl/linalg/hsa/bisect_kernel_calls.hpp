#ifndef VIENNACL_LINALG_HSA_BISECT_KERNEL_CALLS_HPP_
#define VIENNACL_LINALG_HSA_BISECT_KERNEL_CALLS_HPP_
...
void bisectSmall(const viennacl::linalg::detail::InputData<NumericT> &input,
    ...
    {
      viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(input.g_a));
      viennacl::linalg::opencl::kernels::bisect_kernel<NumericT, viennacl::hsa::context>::init(ctx);

      viennacl::hsa::kernel& kernel = ctx.get_kernel(viennacl::linalg::opencl::kernels::bisect_kernel<NumericT>::program_name(), BISECT_KERNEL_SMALL);
      ...
      viennacl::hsa::enqueue(kernel(viennacl::traits::hsa_handle(input.g_a),
                                    viennacl::traits::hsa_handle(input.g_b),
                                    static_cast<cl_uint>(mat_size),
                                    viennacl::traits::hsa_handle(result.vcl_g_left),
                                    viennacl::traits::hsa_handle(result.vcl_g_right),
                                    viennacl::traits::hsa_handle(result.vcl_g_left_count),
                                    viennacl::traits::hsa_handle(result.vcl_g_right_count),
...
void bisectLarge(const viennacl::linalg::detail::InputData<NumericT> &input,
                 ...
                 const NumericT precision)
    {
      ...
      viennacl::hsa::kernel& kernel = ctx.get_kernel(viennacl::linalg::opencl::kernels::bisect_kernel<NumericT>::program_name(), BISECT_KERNEL_LARGE);
      ...
      viennacl::hsa::enqueue(kernel(viennacl::traits::hsa_handle(input.g_a),
                                    ...
                                    static_cast<cl_uint>(mat_size),
                                    static_cast<NumericT>(precision),
                                    viennacl::traits::hsa_handle(result.g_num_one),
                                    viennacl::traits::hsa_handle(result.g_num_blocks_mult),
                                    viennacl::traits::hsa_handle(result.g_left_one),
                                    viennacl::traits::hsa_handle(result.g_right_one),
                                    viennacl::traits::hsa_handle(result.g_pos_one),
                                    viennacl::traits::hsa_handle(result.g_left_mult),
                                    viennacl::traits::hsa_handle(result.g_right_mult),
                                    viennacl::traits::hsa_handle(result.g_left_count_mult),
                                    viennacl::traits::hsa_handle(result.g_right_count_mult),
                                    viennacl::traits::hsa_handle(result.g_blocks_mult),
                                    viennacl::traits::hsa_handle(result.g_blocks_mult_sum)
                            ));
...
void bisectLargeOneIntervals(const viennacl::linalg::detail::InputData<NumericT> &input,
                             ...
                             const NumericT precision)
    {
      ...
      viennacl::hsa::kernel& kernel = ctx.get_kernel(viennacl::linalg::opencl::kernels::bisect_kernel<NumericT>::program_name(), BISECT_KERNEL_LARGE_ONE_INTERVALS);
...
void bisectLargeMultIntervals(const viennacl::linalg::detail::InputData<NumericT> &input,
                              ...
                              const NumericT precision)
    {
      ...
      viennacl::hsa::kernel& kernel = ctx.get_kernel(viennacl::linalg::opencl::kernels::bisect_kernel<NumericT>::program_name(), BISECT_KERNEL_LARGE_MULT_INTERVALS);
      ...
      viennacl::hsa::enqueue(kernel(viennacl::traits::hsa_handle(input.g_a),
                                    ...
                                    viennacl::traits::hsa_handle(result.g_left_count_mult),
                                    viennacl::traits::hsa_handle(result.g_right_count_mult),
                                    viennacl::traits::hsa_handle(result.g_lambda_mult),
                                    viennacl::traits::hsa_handle(result.g_pos_mult),
                                    static_cast<NumericT>(precision)
                            ));
    }
} // namespace hsa
