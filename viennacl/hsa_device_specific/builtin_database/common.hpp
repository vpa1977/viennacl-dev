#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_COMMON_HPP_
#define VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_COMMON_HPP_
...
/** @file viennacl/hsa_device_specific/builtin_database/common.hpp
*
...
inline ParamT const & get_parameters(database_type<ParamT> const & database, vcl::device const & device)
{
