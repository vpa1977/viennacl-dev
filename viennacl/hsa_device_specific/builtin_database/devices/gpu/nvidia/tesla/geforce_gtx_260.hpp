#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_DEVICES_GPU_NVIDIA_TESLA_HPP_
#define VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_DEVICES_GPU_NVIDIA_TESLA_HPP_
...
{
  db.add_4B(ocl::nvidia_id, CL_DEVICE_TYPE_GPU, ocl::tesla, "GeForce GTX 260", matrix_product_template::parameters_type(1,32,2,16,1,1,4,FETCH_FROM_GLOBAL_STRIDED,FETCH_FROM_GLOBAL_CONTIGUOUS,0,0));
}
...
{
  db.add_4B(ocl::nvidia_id, CL_DEVICE_TYPE_GPU, ocl::tesla, "GeForce GTX 260", matrix_product_template::parameters_type(1,16,2,16,1,1,4,FETCH_FROM_GLOBAL_STRIDED,FETCH_FROM_GLOBAL_CONTIGUOUS,0,0));
}
...
{
  db.add_8B(ocl::nvidia_id, CL_DEVICE_TYPE_GPU, ocl::tesla, "GeForce GTX 260", row_wise_reduction_template::parameters_type(1,2,32,2048,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_8B(database_type<row_wise_reduction_template::parameters_type> & db, char_to_type<'N'>)
{
  db.add_8B(ocl::nvidia_id, CL_DEVICE_TYPE_GPU, ocl::tesla, "GeForce GTX 260", row_wise_reduction_template::parameters_type(1,32,4,256,FETCH_FROM_GLOBAL_CONTIGUOUS));
}

inline void add_4B(database_type<row_wise_reduction_template::parameters_type> & db, char_to_type<'T'>)
{
  db.add_4B(ocl::nvidia_id, CL_DEVICE_TYPE_GPU, ocl::tesla, "GeForce GTX 260", row_wise_reduction_template::parameters_type(1,1,64,1024,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_4B(database_type<row_wise_reduction_template::parameters_type> & db, char_to_type<'N'>)
{
  db.add_4B(ocl::nvidia_id, CL_DEVICE_TYPE_GPU, ocl::tesla, "GeForce GTX 260", row_wise_reduction_template::parameters_type(4,32,16,32,FETCH_FROM_GLOBAL_CONTIGUOUS));
}

inline void add_8B(database_type<reduction_template::parameters_type> & db)
{
  db.add_8B(ocl::nvidia_id, CL_DEVICE_TYPE_GPU, ocl::tesla, "GeForce GTX 260", reduction_template::parameters_type(1,64,512,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_4B(database_type<reduction_template::parameters_type> & db)
{
  db.add_4B(ocl::nvidia_id, CL_DEVICE_TYPE_GPU, ocl::tesla, "GeForce GTX 260", reduction_template::parameters_type(1,128,512,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_8B(database_type<matrix_axpy_template::parameters_type> & db)
{
  db.add_8B(ocl::nvidia_id, CL_DEVICE_TYPE_GPU, ocl::tesla, "GeForce GTX 260", matrix_axpy_template::parameters_type(1,32,4,128,2,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_4B(database_type<matrix_axpy_template::parameters_type> & db)
{
  db.add_4B(ocl::nvidia_id, CL_DEVICE_TYPE_GPU, ocl::tesla, "GeForce GTX 260", matrix_axpy_template::parameters_type(1,64,2,64,16,FETCH_FROM_GLOBAL_CONTIGUOUS));
}

inline void add_8B(database_type<vector_axpy_template::parameters_type> & db)
{
  db.add_8B(ocl::nvidia_id, CL_DEVICE_TYPE_GPU, ocl::tesla, "GeForce GTX 260", vector_axpy_template::parameters_type(1,32,16384,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_4B(database_type<vector_axpy_template::parameters_type> & db)
{
  db.add_4B(ocl::nvidia_id, CL_DEVICE_TYPE_GPU, ocl::tesla, "GeForce GTX 260", vector_axpy_template::parameters_type(1,128,16384,FETCH_FROM_GLOBAL_STRIDED));
}
