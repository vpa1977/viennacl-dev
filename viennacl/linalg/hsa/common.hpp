#ifndef VIENNACL_LINALG_HSA_COMMON_HPP_
#define VIENNACL_LINALG_HSA_COMMON_HPP_
...
viennacl::hsa::device const & current_device(SomeT const & obj) {  return traits::opencl_handle(obj).context().current_device(); }
