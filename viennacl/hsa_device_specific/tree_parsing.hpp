#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_TREE_PARSING_HPP
#define VIENNACL_HSA_DEVICE_SPECIFIC_TREE_PARSING_HPP
...
/** @file viennacl/hsa_device_specific/tree_parsing.hpp
