#ifndef VIENNACL_SCHEDULER_HSA_PRESET_HPP_
#define VIENNACL_SCHEDULER_HSA_PRESET_HPP_
...
viennacl::hsa_specific::statements_container plane_rotation(vector_base<NumericT> const * x, vector_base<NumericT> const * y, NumericT const * a, NumericT const * b)
{
  return viennacl::hsa_specific::statements_container(avbv(OPERATION_BINARY_ASSIGN_TYPE, x, x, a, false, false, y, b, false, false),
                                               avbv(OPERATION_BINARY_ASSIGN_TYPE, y, y, a, false, false, x, b, true, false),
                                               viennacl::hsa_specific::statements_container::INDEPENDENT);
}

template<typename NumericT>
   viennacl::hsa_specific::statements_container
/* viennacl::hsa_specific::statements_container*/ swap(NumericT const * x, NumericT const * y)
{
  vcl_size_t dummy = 0;
  ...
  return viennacl::hsa_specific::statements_container(scheduler::statement(array0), scheduler::statement(array1), viennacl::hsa_specific::statements_container::INDEPENDENT);
}
