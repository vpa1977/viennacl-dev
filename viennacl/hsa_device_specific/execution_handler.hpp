#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_EXECUTION_HANDLER_HPP
#define VIENNACL_HSA_DEVICE_SPECIFIC_EXECUTION_HANDLER_HPP
...
/** @file viennacl/hsa_device_specific/execution_handler.hpp
...
#include "viennacl/hsa_device_specific/templates/template_base.hpp"
...
public:
  execution_handler(std::string const & program_name_base, vcl::context & ctx, vcl::device const & device, bool force_recompilation = false) : ctx_(ctx), device_(device), program_names_(2)
  {
