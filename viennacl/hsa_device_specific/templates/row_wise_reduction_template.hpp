#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_TEMPLATES_ROW_WISE_REDUCTION_HPP
#define VIENNACL_HSA_DEVICE_SPECIFIC_TEMPLATES_ROW_WISE_REDUCTION_HPP
...
/** @file viennacl/hsa_device_specific/templates/row_wise_reduction_template.hpp
 *
...
{
private:
  virtual int check_invalid_impl(vcl::device const & /*dev*/) const
  {
