#ifndef VIENNACL_LINALG_HSA_KERNELS_SVD_HPP
#define VIENNACL_LINALG_HSA_KERNELS_SVD_HPP
...
struct svd
{
  static std::string program_name()
  {
    ...
    return (viennacl::hsa::type_to_string<NumericT>::apply() + "_svd_") + (is_row ? "row" : "col");
  }
