#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_TEMPLATES_VECTOR_AXPY_HPP
#define VIENNACL_HSA_DEVICE_SPECIFIC_TEMPLATES_VECTOR_AXPY_HPP
...
/** @file viennacl/hsa_device_specific/templates/vector_axpy_template.hpp
 *
