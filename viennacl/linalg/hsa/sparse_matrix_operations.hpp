#ifndef VIENNACL_LINALG_HSA_SPARSE_MATRIX_OPERATIONS_HPP_
#define VIENNACL_LINALG_HSA_SPARSE_MATRIX_OPERATIONS_HPP_
...
namespace detail
{
                ...
                viennacl::linalg::detail::row_info_types info_selector)
  {
    ...
    viennacl::linalg::opencl::kernels::compressed_matrix<NumericT, viennacl::hsa::context>::init(ctx);
    viennacl::hsa::kernel & row_info_kernel = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "row_info_extractor");

    viennacl::hsa::enqueue(row_info_kernel(A.handle1().hsa_handle(), A.handle2().hsa_handle(), A.handle().hsa_handle(),
                     ...
                     viennacl::vector_base<NumericT> & y)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), ss.str());

  viennacl::hsa::packed_cl_uint layout_x;
  ...
  viennacl::hsa::packed_cl_uint layout_y;
  ...
  {
    viennacl::hsa::enqueue(k(A.handle1().hsa_handle(), A.handle2().hsa_handle(), A.handle().hsa_handle(),
                             x, layout_x,
                             y, layout_y
                            ));
  }
  else
  {
    ...
    if (use_nvidia_specific)
    {
      ...
      viennacl::hsa::enqueue(k(A.handle1().hsa_handle(), A.handle2().hsa_handle(), A.handle3().hsa_handle(), A.handle().hsa_handle(), cl_uint(A.blocks1()),
                               x, layout_x,
                               y, layout_y
                              ));
    }
...
void prod_impl(const viennacl::compressed_matrix<NumericT, AlignmentV> & sp_A,
  ...
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(sp_A));
  viennacl::linalg::opencl::kernels::compressed_matrix<NumericT, viennacl::hsa::context>::init(ctx);
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(),
                                             detail::sparse_dense_matmult_kernel_name(false, d_A.row_major(), y.row_major()));

  viennacl::hsa::enqueue(k(sp_A.handle1().hsa_handle(), sp_A.handle2().hsa_handle(), sp_A.handle().hsa_handle(),
                           viennacl::traits::hsa_handle(d_A),
...
void prod_impl(viennacl::compressed_matrix<NumericT, AlignmentV> const & sp_A,
  ...
  viennacl::hsa::enqueue(k(sp_A.handle1().hsa_handle(), sp_A.handle2().hsa_handle(), sp_A.handle().hsa_handle(),
                           viennacl::traits::hsa_handle(d_A.lhs()),
               ...
               viennacl::compressed_matrix<NumericT, AlignmentV> & C)
{
  ...
  viennacl::hsa::kernel & k1 = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "spgemm_stage1");
  viennacl::hsa::enqueue(k1(A.handle1().hsa_handle(), A.handle2().hsa_handle(), cl_uint(A.size1()),
                            viennacl::traits::hsa_handle(upper_bound_nonzeros_per_row_A)
                        )  );
  ...
  if (max_nnz_per_row_A > 32)
  {
    ...
    viennacl::hsa::kernel & k_decompose_1 = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "spgemm_decompose_1");
    viennacl::hsa::enqueue(k_decompose_1(A.handle1().hsa_handle(), cl_uint(A.size1()),
                                         cl_uint(max_entries_in_G),
                                         viennacl::traits::hsa_handle(exclusive_scan_helper)
                          )             );
    ...
    // fill A2:
    viennacl::hsa::kernel & k_fill_A2 = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "spgemm_A2");
    viennacl::hsa::enqueue(k_fill_A2(A2.handle1().hsa_handle(), A2.handle2().hsa_handle(), A2.handle().hsa_handle(), cl_uint(A2.size1()),
                                     viennacl::traits::hsa_handle(exclusive_scan_helper)
                          )         );

    // fill G1:
    viennacl::hsa::kernel & k_fill_G1 = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "spgemm_G1");
    viennacl::hsa::enqueue(k_fill_G1(G1.handle1().hsa_handle(), G1.handle2().hsa_handle(), G1.handle().hsa_handle(), cl_uint(G1.size1()),
                                     A.handle1().hsa_handle(), A.handle2().hsa_handle(), A.handle().hsa_handle(), cl_uint(A.size1()), cl_uint(A.nnz()),
                                     cl_uint(max_entries_in_G),
                                     viennacl::traits::hsa_handle(exclusive_scan_helper)
                          )         );
  ...
  viennacl::hsa::kernel & k2 = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "spgemm_stage2");
  ...
  viennacl::hsa::enqueue(k2(A.handle1().hsa_handle(), A.handle2().hsa_handle(), cl_uint(A.size1()),
                            B.handle1().hsa_handle(), B.handle2().hsa_handle(), cl_uint(B.size2()),
                            C.handle1().hsa_handle()
                        )  );
  ...
  viennacl::hsa::kernel & k3 = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "spgemm_stage3");
  ...
  viennacl::hsa::enqueue(k3(A.handle1().hsa_handle(), A.handle2().hsa_handle(), A.handle().hsa_handle(), cl_uint(A.size1()),
                            B.handle1().hsa_handle(), B.handle2().hsa_handle(), B.handle().hsa_handle(), cl_uint(B.size2()),
                            C.handle1().hsa_handle(), C.handle2().hsa_handle(), C.handle().hsa_handle()
                        )  );
                   ...
                   viennacl::linalg::lower_tag)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "lu_forward");
...
{
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(U));
  viennacl::linalg::opencl::kernels::compressed_matrix<NumericT, viennacl::hsa::context>::init(ctx);
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "unit_lu_backward");
                   ...
                   viennacl::linalg::upper_tag)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "lu_backward");
...
namespace detail
{
  ...
  void block_inplace_solve(const matrix_expression<const compressed_matrix<NumericT, AlignmentV>,
                           ...
                           viennacl::linalg::unit_lower_tag)
  {
    viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(L.lhs()));
    viennacl::linalg::opencl::kernels::compressed_matrix<NumericT, viennacl::hsa::context>::init(ctx);
    viennacl::hsa::kernel & block_solve_kernel = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "block_trans_unit_lu_forward");
    block_solve_kernel.global_work_size(0, num_blocks * block_solve_kernel.local_work_size(0));

    viennacl::hsa::enqueue(block_solve_kernel(L.lhs().handle1().hsa_handle(),
                                              L.lhs().handle2().hsa_handle(),
                                              L.lhs().handle().hsa_handle(),
                                              block_indices.hsa_handle(),
                                              x,
  ...
  void block_inplace_solve(matrix_expression<const compressed_matrix<NumericT, AlignmentV>,
                           ...
                           viennacl::linalg::upper_tag)
  {
    viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(U.lhs()));
    viennacl::linalg::opencl::kernels::compressed_matrix<NumericT, viennacl::hsa::context>::init(ctx);
    viennacl::hsa::kernel & block_solve_kernel = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "block_trans_lu_backward");
    block_solve_kernel.global_work_size(0, num_blocks * block_solve_kernel.local_work_size(0));

    viennacl::hsa::enqueue(block_solve_kernel(U.lhs().handle1().hsa_handle(),
                                              U.lhs().handle2().hsa_handle(),
                                              U.lhs().handle().hsa_handle(),
                                              U_diagonal,
                                              block_indices.hsa_handle(),
                                              x,
                                              static_cast<cl_uint>(x.size())));
...
void inplace_solve(matrix_expression< const compressed_matrix<NumericT, AlignmentV>,
                   ...
                   viennacl::linalg::unit_lower_tag)
{
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(proxy_L.lhs()));
  viennacl::linalg::opencl::kernels::compressed_matrix<NumericT, viennacl::hsa::context>::init(ctx);
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "trans_unit_lu_forward");
                   ...
                   viennacl::linalg::lower_tag)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "trans_lu_forward");
...
void inplace_solve(matrix_expression< const compressed_matrix<NumericT, AlignmentV>,
                   ...
                   viennacl::linalg::unit_upper_tag)
{
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(proxy_U.lhs()));
  viennacl::linalg::opencl::kernels::compressed_matrix<NumericT, viennacl::hsa::context>::init(ctx);
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "trans_unit_lu_backward");
                   ...
                   viennacl::linalg::upper_tag)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_matrix<NumericT>::program_name(), "trans_lu_backward");
...
{
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(A));
  viennacl::linalg::opencl::kernels::compressed_compressed_matrix<NumericT, viennacl::hsa::context>::init(ctx);
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::compressed_compressed_matrix<NumericT>::program_name(), "vec_mul");
  ...
  viennacl::hsa::enqueue(k(A.handle1().hsa_handle(), A.handle3().hsa_handle(), A.handle2().hsa_handle(), A.handle().hsa_handle(), cl_uint(A.nnz1()),
                           x, layout_x,
                           y, layout_y
                          ));
}
...
namespace detail
{
  ...
  {
    viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(A));
    viennacl::linalg::opencl::kernels::coordinate_matrix<NumericT, viennacl::hsa::context>::init(ctx);
    viennacl::hsa::kernel & row_info_kernel = ctx.get_kernel(viennacl::linalg::opencl::kernels::coordinate_matrix<NumericT>::program_name(), "row_info_extractor");
    ...
    viennacl::hsa::enqueue(row_info_kernel(A.handle12().hsa_handle(), A.handle().hsa_handle(), A.handle3().hsa_handle(),
                                           viennacl::traits::hsa_handle(x),
                                           cl_uint(info_selector),
                                           viennacl::hsa::local_mem(sizeof(cl_uint)*thread_num),
                                           viennacl::hsa::local_mem(sizeof(NumericT)*thread_num)) );
  }
}
               ...
               viennacl::vector_base<NumericT>       & y)
{
  ...
  viennacl::hsa::enqueue(k(A.handle12().hsa_handle(), A.handle().hsa_handle(), A.handle3().hsa_handle(),
                           viennacl::traits::hsa_handle(x),
                           layout_x,
                           viennacl::traits::hsa_handle(y),
                           layout_y,
               ...
               viennacl::matrix_base<NumericT>       & y)
{
  ...
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::coordinate_matrix<NumericT>::program_name(),
                                             detail::sparse_dense_matmult_kernel_name(false, d_A.row_major(), y.row_major()));
  ...
  viennacl::hsa::enqueue(k(A.handle12().hsa_handle(), A.handle().hsa_handle(), A.handle3().hsa_handle(),
                           ...
                           cl_uint(viennacl::traits::size1(y)),          cl_uint(viennacl::traits::size2(y)),
                           cl_uint(viennacl::traits::internal_size1(y)), cl_uint(viennacl::traits::internal_size2(y)),
                           viennacl::hsa::local_mem(sizeof(cl_uint)*k.local_work_size(0)),
                           viennacl::hsa::local_mem(sizeof(NumericT)*k.local_work_size(0))) );
               ...
               viennacl::vector_base<NumericT>       & y)
{
  ...
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(A));
  viennacl::linalg::opencl::kernels::ell_matrix<NumericT, viennacl::hsa::context>::init(ctx);
  y.clear();
  ...
  viennacl::hsa::kernel& k = ctx.get_kernel(viennacl::linalg::opencl::kernels::ell_matrix<NumericT>::program_name(), "vec_mul");
  ...
  viennacl::hsa::enqueue(k(A.handle2().hsa_handle(),
                           A.handle().hsa_handle(),
                           viennacl::traits::hsa_handle(x),
                           layout_x,
                           viennacl::traits::hsa_handle(y),
...
void prod_impl(viennacl::ell_matrix<NumericT, AlignmentV> const & sp_A,
  ...
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(sp_A));
  viennacl::linalg::opencl::kernels::ell_matrix<NumericT, viennacl::hsa::context>::init(ctx);
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::ell_matrix<NumericT>::program_name(),
                                             detail::sparse_dense_matmult_kernel_name(false, d_A.row_major(), y.row_major()));
  ...
  viennacl::hsa::enqueue(k(sp_A.handle2().hsa_handle(), sp_A.handle().hsa_handle(),
                           cl_uint(sp_A.size1()),
                           cl_uint(sp_A.size2()),
               ...
               viennacl::vector_base<ScalarT>       & y)
{
  ...
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(A));
  viennacl::linalg::opencl::kernels::sliced_ell_matrix<ScalarT, unsigned int, viennacl::hsa::context>::init(ctx);
  y.clear();
  ...
  std::stringstream ss;
  ss << "vec_mul_" << 1;//(AlignmentV != 1?4:1);
  viennacl::hsa::kernel& k = ctx.get_kernel(viennacl::linalg::opencl::kernels::sliced_ell_matrix<ScalarT, IndexT>::program_name(), "vec_mul");
  ...
  viennacl::hsa::enqueue(k(A.handle1().hsa_handle(),
                           A.handle2().hsa_handle(),
                           A.handle3().hsa_handle(),
                           A.handle().hsa_handle(),
                           viennacl::traits::hsa_handle(x),
                           layout_x,
                           viennacl::traits::hsa_handle(y),
               ...
               viennacl::vector_base<NumericT>       & y)
{
  ...
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(A));
  viennacl::linalg::opencl::kernels::hyb_matrix<NumericT, viennacl::hsa::context>::init(ctx);
  ...
  viennacl::hsa::kernel& k = ctx.get_kernel(viennacl::linalg::opencl::kernels::hyb_matrix<NumericT>::program_name(), "vec_mul");

  viennacl::hsa::enqueue(k(A.handle2().hsa_handle(),
                           A.handle().hsa_handle(),
                           A.handle3().hsa_handle(),
                           A.handle4().hsa_handle(),
                           A.handle5().hsa_handle(),
                           viennacl::traits::hsa_handle(x),
                           layout_x,
                           viennacl::traits::hsa_handle(y),
                           layout_y,
               ...
               viennacl::matrix_base<NumericT>       & y)
{
  viennacl::hsa::context & ctx = const_cast<viennacl::hsa::context &>(viennacl::traits::hsa_context(A));
  viennacl::linalg::opencl::kernels::hyb_matrix<NumericT, viennacl::hsa::context>::init(ctx);
  viennacl::hsa::kernel & k = ctx.get_kernel(viennacl::linalg::opencl::kernels::hyb_matrix<NumericT>::program_name(),
                                             detail::sparse_dense_matmult_kernel_name(false, d_A.row_major(), y.row_major()));
