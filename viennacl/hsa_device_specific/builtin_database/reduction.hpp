#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_REDUCTION_HPP_
#define VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_REDUCTION_HPP_
...
/** @file viennacl/hsa_device_specific/builtin_database/reduction.hpp
*
...
reduction_template::parameters_type const & reduction_params(vcl::device const & device)
{
