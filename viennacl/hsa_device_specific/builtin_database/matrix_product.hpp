#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_MATRIX_PRODUCT_HPP_
#define VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_MATRIX_PRODUCT_HPP_
...
#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/amd/northern_islands/barts.hpp"

#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/nvidia/fermi/tesla_c2050.hpp"

#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/nvidia/fermi/geforce_gtx_470.hpp"

#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/nvidia/maxwell/geforce_gtx_750_ti.hpp"

#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/amd/northern_islands/scrapper.hpp"

#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/nvidia/tesla/geforce_gtx_260.hpp"

#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/amd/southern_islands/tahiti.hpp"
#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/amd/northern_islands/devastator.hpp"

#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/nvidia/kepler/tesla_k20m.hpp"
#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/nvidia/fermi/geforce_gtx_580.hpp"

#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/amd/volcanic_islands/hawaii.hpp"

#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/amd/evergreen/cypress.hpp"
#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/amd/evergreen/cedar.hpp"


#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/nvidia/fermi/geforce_gt_540m.hpp"


#include "viennacl/ocl/device_utils.hpp"
#include "viennacl/scheduler/forwards.h"

#include "viennacl/hsa_device_specific/builtin_database/devices/accelerator/fallback.hpp"
#include "viennacl/hsa_device_specific/builtin_database/devices/cpu/fallback.hpp"
#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/fallback.hpp"
#include "viennacl/hsa_device_specific/builtin_database/devices/gpu/nvidia/fermi/geforce_gt_540m.hpp"

/** @file viennacl/hsa_device_specific/builtin_database/matrix_product.hpp
*
...
matrix_product_template::parameters_type const & matrix_product_params(hsa::device const & device, char A_trans, char B_trans)
{
