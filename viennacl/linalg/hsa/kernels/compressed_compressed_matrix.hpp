#ifndef VIENNACL_LINALG_HSA_KERNELS_COMPRESSED_COMPRESSED_MATRIX_HPP
#define VIENNACL_LINALG_HSA_KERNELS_COMPRESSED_COMPRESSED_MATRIX_HPP
...
struct compressed_compressed_matrix
{
  ...
  {
    return viennacl::hsa::type_to_string<NumericT>::apply() + "_compressed_compressed_matrix";
  }
