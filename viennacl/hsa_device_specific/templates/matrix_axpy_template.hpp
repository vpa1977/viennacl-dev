#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_TEMPLATES_MATRIX_AXPY_HPP
#define VIENNACL_HSA_DEVICE_SPECIFIC_TEMPLATES_MATRIX_AXPY_HPP
...
/** @file viennacl/hsa_device_specific/templates/matrix_axpy_template.hpp
 *
...
public:
  ...
  {
    vcl::kernel & kernel = programs[0].program().get_kernel(kernel_prefix);
