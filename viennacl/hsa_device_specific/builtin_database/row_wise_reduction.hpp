#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_ROW_WISE_REDUCTION_HPP_
#define VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_ROW_WISE_REDUCTION_HPP_
...
/** @file viennacl/hsa_device_specific/builtin_database/row_wise_reduction.hpp
*
