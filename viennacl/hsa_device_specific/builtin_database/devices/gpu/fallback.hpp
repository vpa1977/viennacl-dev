#ifndef VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_DEVICES_GPU_FALLBACK_HPP_
#define VIENNACL_HSA_DEVICE_SPECIFIC_BUILTIN_DATABASE_DEVICES_GPU_FALLBACK_HPP_
...
{
  db.add_4B(ocl::unknown_id, CL_DEVICE_TYPE_GPU, ocl::unknown, "", vector_axpy_template::parameters_type(1,128,128,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_4B(database_type<reduction_template::parameters_type> & db)
{
  db.add_4B(ocl::unknown_id, CL_DEVICE_TYPE_GPU, ocl::unknown, "", reduction_template::parameters_type(1,128,128,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_4B(database_type<matrix_axpy_template::parameters_type> & db)
{
  db.add_4B(ocl::unknown_id, CL_DEVICE_TYPE_GPU, ocl::unknown, "", matrix_axpy_template::parameters_type(1,8,8,8,8,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_4B(database_type<row_wise_reduction_template::parameters_type> & db, char_to_type<'N'>)
{
  db.add_4B(ocl::unknown_id, CL_DEVICE_TYPE_GPU, ocl::unknown, "", row_wise_reduction_template::parameters_type(1,1,128,128, FETCH_FROM_GLOBAL_STRIDED));
}
...
{
  db.add_4B(ocl::unknown_id, CL_DEVICE_TYPE_GPU, ocl::unknown, "", matrix_product_template::parameters_type(1,8,8,8,4,4,4,FETCH_FROM_LOCAL,FETCH_FROM_LOCAL,8,8));
}
...
{
  db.add_8B(ocl::unknown_id, CL_DEVICE_TYPE_GPU, ocl::unknown, "", vector_axpy_template::parameters_type(1,128,128,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_8B(database_type<reduction_template::parameters_type> & db)
{
  db.add_8B(ocl::unknown_id, CL_DEVICE_TYPE_GPU, ocl::unknown, "", reduction_template::parameters_type(1,128,128,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_8B(database_type<matrix_axpy_template::parameters_type> & db)
{
  db.add_8B(ocl::unknown_id, CL_DEVICE_TYPE_GPU, ocl::unknown, "", matrix_axpy_template::parameters_type(1,8,8,8,8,FETCH_FROM_GLOBAL_STRIDED));
}

inline void add_8B(database_type<row_wise_reduction_template::parameters_type> & db, char_to_type<'N'>)
{
  db.add_8B(ocl::unknown_id, CL_DEVICE_TYPE_GPU, ocl::unknown, "", row_wise_reduction_template::parameters_type(1,1,128,128, FETCH_FROM_GLOBAL_STRIDED));
}
...
{
  db.add_8B(ocl::unknown_id, CL_DEVICE_TYPE_GPU, ocl::unknown, "", matrix_product_template::parameters_type(1,8,8,8,4,4,4,FETCH_FROM_LOCAL,FETCH_FROM_LOCAL,8,8));
}
